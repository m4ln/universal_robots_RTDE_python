...
from config import tcp_pos_1, tcp_pos_2, tcp_pos_3, tcp_pos_4
...
if __name__ == "__main__":
    ...
    trajectory1 = PathPlanTranslation(tcp_pos_1, tcp_pos_2, tfinal)
    trajectory2 = PathPlanTranslation(tcp_pos_2, tcp_pos_3, tfinal)
    trajectory3 = PathPlanTranslation(tcp_pos_3, tcp_pos_4, tfinal)
    trajectory4 = PathPlanTranslation(tcp_pos_4, tcp_pos_1, tfinal)

    for trajectory in [trajectory1, trajectory2, trajectory3, trajectory4]:
        posx = []
        posy = []
        posz = []
        v_x = []
